...
function Contact() {
  return (
    <>
      <section className="dark:bg-gray-700 dark:text-blue-100 text-slate-900 body-font relative">
        <div className="container px-5 py-10 mx-auto">
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto text-slate-900 dark:text-blue-100">
            <div className="flex flex-wrap -m-2">
              <div className="p-2 w-1/2">
                <div className="relative">
                  <label
                    for="name"
                    className="leading-7 text-sm text-slate-900 dark:text-blue-100"
                  >
                    Name
                  </label>
                  <input
              ...
              <div className="p-2 w-full">
                <button className="flex mx-auto text-white bg-blue-700 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">
                  Submit
                </button>
              </div>
            </div>
