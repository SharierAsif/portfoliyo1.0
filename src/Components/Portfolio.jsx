  ...
  return (
    <section className="bg-blue-700">
      <div className="container px-6 py-10 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-6 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-4">
          <div>
            <img
              ...
              alt=""
            />
            <h2 className="mt-4 text-xs font-semibold text-gray-800 capitalize dark:text-white">
